...
## Задание 4
Напишите код приложения, интерфейс которого представляет собой **2-х input** и **кнопку *submit***. В **input** можно ввести любое число.
...
## Задание 5
Написать код приложения, интерфейс которого состоит из **2-х input** и **кнопки**. В **input** можно ввести любое число.
